 ...
 * @version    $Id: Barcode.php 8211 2009-02-20 14:29:24Z darby $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Unitech_Validate_Barcode extends Zend_Validate_Abstract
{
    /**
     * Barcode validator
     *
    ...
    public function setType($barcodeType)
    {
        switch (strtolower($barcodeType)) {
            ...
            default:
                ...
                throw new Unitech_Validate_Exception("Barcode type '$barcodeType' is not supported'");
                break;
        }

        require_once 'Unitech/Validate/Barcode/' . $className . '.php';

        $class = 'Unitech_Validate_Barcode_' . $className;
