...
class Zend_Validate_File_Upload extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        self::INI_SIZE       => "Tệp '%value%' vượt quá kích thước quy định",
        self::FORM_SIZE      => "Tệp '%value%' vượt quá kích thước quy định trong form",
        self::PARTIAL        => "The file '%value%' was only partially uploaded",
        self::NO_FILE        => "Chưa có tệp tải lên",
        self::NO_TMP_DIR     => "Không có thư mục tạm cho tệp '%value%'",
        self::CANT_WRITE     => "Tệp '%value%' không thể ghi",
        ...
        self::FILE_NOT_FOUND => "Tệp '%value%' không tìm thấy",
        self::UNKNOWN        => "Lỗi trong quá trình upload tệp '%value%'"
    );
