...
class Zend_Validate_File_Size extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        self::TOO_BIG   => "Kích thước tối đa '%value%' là '%max%' nhưng hiện tại là '%size%'",
        self::TOO_SMALL => "Kích thước tối thiểu '%value%' là '%min%' nhưng hiện tại là '%size%'",
        self::NOT_FOUND => "Tệp '%value%' không tìm thấy"
    );
