...
class wsdl extends nusoap_base {
    ...
    */
    function webDescription(){
		...
		<style type="text/css">
		    body    { font-family: "Segoe UI","Segoe UI Web Regular","Segoe UI Symbol","Helvetica Neue","BBAlpha Sans","S60 Sans",Arial,"sans-serif"; color: #000000; background-color: #ffffff; margin: 0px 0px 0px 0px; }
		    p       { font-family: "Segoe UI","Segoe UI Web Regular","Segoe UI Symbol","Helvetica Neue","BBAlpha Sans","S60 Sans",Arial,"sans-serif"; color: #666666; margin-top: 0px; margin-bottom: 12px; }
		    pre { background-color: silver; padding: 5px; font-family: "Segoe UI","Segoe UI Web Regular","Segoe UI Symbol","Helvetica Neue","BBAlpha Sans","S60 Sans",Arial,"sans-serif"; font-size: x-small; color: #000000;}
		    ul      { margin-top: 10px; margin-left: 20px; }
		    li      { list-style-type: none; margin-top: 10px; color: #000000; }
		    .content{
			margin-left: 0px; padding-bottom: 2em; }
		    .nav {
			padding-top: 10px; padding-bottom: 10px; padding-left: 15px; font-size: 12px;
			margin-top: 10px; margin-left: 0px; color: #000000;
			background-color: #F3F3F3; width: 20%; margin-left: 20px; margin-top: 20px; }
		    .title {
			font-family: "Segoe UI Web Semibold","Segoe UI Web Regular","Segoe UI","Segoe UI Symbol","Helvetica Neue",Arial; font-size: 26px; color: #ffffff;
			background-color: #0072C6; width: 105%; margin-left: 0px;
			padding-top: 10px; padding-bottom: 10px; padding-left: 15px;}
		    .hidden {
			position: absolute; visibility: hidden; z-index: 200; left: 250px; top: 100px;
			font-family: "Segoe UI Web Semibold","Segoe UI Web Regular","Segoe UI","Segoe UI Symbol","Helvetica Neue",Arial; overflow: hidden; width: 100%;
			padding: 20px; font-size: 14px; background-color: #F3F3F3;
			layer-background-color:#FFFFFF; }
		    a,a:active  { color: charcoal; font-weight: bold; }
		    a:visited   { color: #0072C6; font-weight: bold; }
		...
		<div class=content>
			...
			<div class=nav>
				<p>Click <a href="'.$PHP_SELF.'?wsdl">vào đây</a> để xem WSDL của dịch vụ.
				Và click lên một tên phương thức để xem chi tiết.</p>
				<ul>';
				foreach($this->getOperations() as $op => $data){
				    $b .= "<li><a href='#' onclick=\"popout();popup('$op')\">$op</a></li>";
				    // create hidden div
				    $b .= "<div id='$op' class='hidden' style='color:#666666'>
				    <a href='#' onclick='popout()'><font color='#0072C6'>Close</font></a><br><br>";
				    foreach($data as $donnie => $marie){ // loop through opdata
						if($donnie == 'input' || $donnie == 'output'){ // show input/output data
						    $b .= "<font color='#0072C6'>".ucfirst($donnie).':</font><br>';
						    ...
						    $b .= "<font color='#0072C6'>".ucfirst($donnie).":</font> $marie<br>";
						}
				    }
					$b .= '</div>';
				}
