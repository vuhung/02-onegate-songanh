 ...
 * @version    $Id: EmailAddress.php 8985 2009-03-21 21:37:24Z matthew $
 */
...
class Zend_Validate_EmailAddress extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        self::INVALID            => "Địa chỉ email không hợp lệ. Phải có dạng local-part@hostname",
        self::INVALID_HOSTNAME   => "Tên miền của địa chỉ mail không hợp lệ",
