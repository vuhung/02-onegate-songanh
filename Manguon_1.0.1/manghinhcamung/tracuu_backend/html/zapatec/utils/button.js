// $Id: button.js 6971 2007-04-19 20:07:52Z vkulov $
/*
 * <pre>
...
Zapatec.Button.prototype.createButton = function(){
    ...
    Zapatec.Utils.createProperty(this.container, 'onmouseover', function(ev){return self.onmouseover(ev, false);});
    ...
    Zapatec.Utils.addEvent(document, 'mouseup', function(ev){
