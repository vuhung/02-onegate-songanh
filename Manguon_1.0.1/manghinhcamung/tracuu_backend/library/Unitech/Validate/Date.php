 ...
 * @version    $Id: Date.php 9613 2009-06-05 11:49:58Z thomas $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Unitech_Validate_Date extends Zend_Validate_Abstract
{
    /**
    ...
    protected $_messageTemplates = array(
        self::NOT_YYYY_MM_DD => "Giá trị không đúng theo định dạng YYYY-MM-DD",
        self::INVALID        => "Giá trị không hợp lệ",
        self::FALSEFORMAT    => "Giá trị không đúng định dạng"
    );
     ...
     *
     * @param  string $format
     * @return Unitech_Validate_Date provides a fluent interface
     */
